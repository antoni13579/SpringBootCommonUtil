...
public enum CronTriggerMisfireHandlerType 
{
	...
	private final String cronTriggerMisfireHandlerType;
	
	private CronTriggerMisfireHandlerType(final String cronTriggerMisfireHandlerType) 
	{ this.cronTriggerMisfireHandlerType = cronTriggerMisfireHandlerType; }
}