...
{
	public static void callNativeTrans(final Map<String, String> params, final String transPathName) throws Exception
    {
    	if (KettleUtil.init())
    	{ 
	...
	public static void callNativeTrans(final String transPathName) throws Exception
