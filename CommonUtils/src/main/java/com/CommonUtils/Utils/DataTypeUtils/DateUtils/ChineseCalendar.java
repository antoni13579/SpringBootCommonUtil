 ...
 *         ChineseCalendar.Element element=ChineseCalendar.getCalendarDetail("2019-06-06","yyyy-MM-dd");
...
public class ChineseCalendar {
   ...
   static String[] monthChinese=new String[]{ "一", "二", "三", "四", "五", "六", "七", "八", "九", "十", "十一", "十二" };
    ...
    public void calendar(int y, int m) throws ParseException {
        ...
        Integer lY = null, lM=null, lD = 1, lX = 0, tmp1, tmp2, lM2, lY2=null, cs1=null;
            ...
            if (matcher.matches()) {
                ...
                */
                ...
                if (Integer.valueOf(matcher.group(1)).intValue() == (m + 1)) {
                    ...
                    if (matcher.group(3).equals(String.valueOf('*')))   elements.get(Integer.valueOf(matcher.group(0)) - 1).color = "red";
                }
            }
        }
