...
public final class QuartzConfig 
{
	...
	public static SchedulerFactoryBean getSchedulerFactoryBeanInstanceInJdbc(final DataSource dataSource, 
		    																 ...
		    																 final String instanceName) throws QuartzConfigException
	...
	public static SchedulerFactoryBean getSchedulerFactoryBeanInstanceInMemory(final JobFactory jobFactory) throws QuartzConfigException
																	    ...
																	    final String instanceName) throws QuartzConfigException
	{
		...
		switch (jobStoreType)
		{
			...
			case JDBC:
				if (null == dataSource)
				{ throw new QuartzConfigException("需要把作业存储到数据库，必须要指定数据库连接池"); }
			...
			default:
				throw new QuartzConfigException("没有指定作业存储方式！");
		}
		...
		//properties.setProperty("org.quartz.jobStore.maxMisfiresToHandleAtATime", "20")
		result.setQuartzProperties(properties);
	...
	private static class QuartzConfigException extends Exception
	{
		private static final long serialVersionUID = 3411646039689981130L;

		private QuartzConfigException(final String message)
		{ super(message); }
	}
